 ...
 *     </p>
 *     <p>
 *         There are examples and demos for implementation before Java 8 vs. the implementation in Java 8 using Stream API.
 *     </p>
 * </div>
...
public class Java8StreamsDemo {
    ...
    public void java8StreamsSomeExamples() throws IOException {
        ...
        System.out.println("\n\t8. Stream rows from text file, sort, filter and print: ");
        Stream<String> bands1 = Files.lines(Paths.get(this.resourcesDirectory + "/" + FILE_BANDS_TXT));
        ...
        System.out.println("\n\t9. Stream rows from text file as save to List: ");
        List<String> listOfBands = Files.lines(Paths.get(this.resourcesDirectory + "/" + FILE_BANDS_TXT))
        ...
        Stream<String> rows1 = Files.lines(Paths.get(this.resourcesDirectory + "/" + FILE_DATA_CSV));
        ...
        System.out.println("\n\t11. Stream rows from CSV, parse data from rows: ");
        Stream<String> rows2 = Files.lines(Paths.get(this.resourcesDirectory + "/" + FILE_DATA_CSV));
        //  Splitting each row into an array, and array with less than 3 items will be filtered out
        rows2.map(x -> x.split(","))
                .filter(x -> x.length == 3)
        ...
        System.out.println("\n\t12. Stream rows from CSV, store fields in HashMap: ");
        Stream<String> rows3 = Files.lines(Paths.get(this.resourcesDirectory + "/" + FILE_DATA_CSV));
