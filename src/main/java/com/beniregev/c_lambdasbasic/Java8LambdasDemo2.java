...
public class Java8LambdasDemo2 {
    ...
    /**
     * This is a simple iteration on a {@link List} without using a Lambda.
     */
    ...
    /**
     * Given an array of {@link String}s, for each {@link String} replace all spaces with a dash (-).
     * Note: There are several ways to do it, this is only one.
     */
